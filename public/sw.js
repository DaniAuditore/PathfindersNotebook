/* Privacy-safe PWA worker: caches only public immutable Next static assets. */
...
self.addEventListener("fetch", (event) => {
  ...
  // Login is the sole public document allowed to use the cached connection help.
  // Do not cache its HTML: the fallback is used only after its network request fails.
